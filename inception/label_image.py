...
#    tf.logging.fatal('image file does not exist %s', FLAGS.image)
  ...
  IMG_PATH = "../data/IRTest/"
  result = [None]*len(os.listdir(IMG_PATH))
  counter = 0
  ...
  for filename in os.listdir(IMG_PATH):
      ...
      print("Label: " + str(label) + ". Prediction: " + str(prediction))
      print("Running Accuracy: " + str(correct_predictions/counter))
      print("")

  accuracy = correct_predictions/len(os.listdir(IMG_PATH))
