...
def read_data_sets(total_samples=None, train_file="./direction_gesture_train_data_temp.npz",
                   test_file="./direction_gesture_test_data_temp.npz"):

    IMG_PATH = "./data/images/directionGesture/images64/"
    ...
    train_files = [x for x in all_files_list if "grass" not in x]
    test_files = [x for x in all_files_list if "grass" in x]
...
def get_image_info(image_name):
    ...
    return {"id": info[0], "name": info[1], "label": int(info[2])}
